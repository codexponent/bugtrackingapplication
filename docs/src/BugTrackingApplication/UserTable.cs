        ...
        private void updateButton_Click(object sender, EventArgs e) {
            ...
            if (util.IsValidEmail(emailTextBox.Text)) {
                ...
                if (checkEmail != emailTextBox.Text) {
                    ...
                    string sqlQuery = "UPDATE userTable SET name = '" + nameTextBox.Text + "', username = '" + userNameTextBox.Text + "', email = '" + emailTextBox.Text + "', password = '" + passwordTextBox.Text + "', gender = '" + genderTextBox.Text + "', address = '" + addressTextBox.Text + "', flag = " + userFlag + "WHERE id = " + userId;
                    if (dataconnection.updateConnectionStart(sqlQuery) == "1") {
                        // Update Successfull
                        MetroMessageBox.Show(this, "Update Process Completed and you are Registered As " + emailTextBox.Text, "Update Successful", MessageBoxButtons.OK, MessageBoxIcon.None);
