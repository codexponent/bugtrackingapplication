    ...
    public partial class LogInForm : MetroForm {
        ...
        private void loginButton_Click_1(object sender, EventArgs e) {
            ...
            if (util.IsValidEmail(emailTextBox.Text)) {
                string sqlQuery = "SELECT COUNT(*) FROM userTable WHERE email = '" + emailTextBox.Text + "' AND password = '" + passwordTextBox.Text + "'";   //SQL Query for Select
                if (dataconnection.selectConnectionStart(sqlQuery) == "1") {
                    ...
                    string sqlQuery1 = "SELECT flag FROM userTable WHERE email = '" + emailTextBox.Text + "' AND password = '" + passwordTextBox.Text + "'";   //SQL Query for Select
                    ...
                    if (Int32.Parse(dataconnection.selectConnectionStart(sqlQuery1)) == 1) {
                        ...
                        string sqlQuery2 = "SELECT role FROM userTable WHERE email = '" + emailTextBox.Text + "' AND password = '" + passwordTextBox.Text + "'";   //SQL Query for Select
